...
@section('clientDashboard')
    ...
    <div class="">
        <div  class="mx-10 mt-6 rounded-t-md bg-gradient-to-r bg-gray-600 shadow text-2xl text-white">
        {{-- <a  class="font-bold pl-2 flex justify-end ">Products</a> --}}


<!-- Modal toggle -->
<div class="flex justify-end ">
    <a  data-modal-target="default-modal" data-modal-toggle="default-modal" class="text-white hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >
        Add Products
      </a>
</div>
  ...
  method="POST"
  enctype="multipart/form-data"
  class="w-full  max-h-[90vh] overflow-y-auto rounded-md border border-gray-300 bg-white text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 shadow-lg"
>
@csrf
...
<div class="px-4 py-6 space-y-4">
 ...
 <label class="block">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
   ...
   <div class="flex justify-end items-center border-t border-gray-200 p-4 dark:border-gray-700 dark:bg-gray-800">
    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm">Add Post</button>
  </div>
        ...
        <div class="">
            <div class=" mx-10 md:mx-6 sm:mx-2 rounded-t-md  px-4 pl-4 shadow text-2xl text-white">
                <div class="flex flex-col">
                    <div class=" overflow-x-auto pb-4">
                        <div class="min-w-full inline-block align-middle">
                            <div class="overflow-hidden  border rounded-b-md border-gray-300">
                                <table class="table-auto min-w-full rounded-xl">
                                    <thead>
                                        <tr class="bg-gray-50">
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">Id</th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Company </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> User ID </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Full Name &amp; Email </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Type </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Industry Type </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Join Date </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Budget </th>
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Country </th>
                                           
                                            <th scope="col" class="p-2 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Actions </th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-300 ">
                                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> 1</td>
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Louis Vuitton</td>
                                            ...
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Customer</td>
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Accessories</td>
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jun. 24, 2023 </td>
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $18,500 </td>
                                            <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> United States </td>
                                            
                                            <td class="flex p-2 items-center gap-0.5">
    ...
    <div class="mt-10">
    <p class="px-6 font-bold text-gray-600 text-center">Distributed By: <a href="">Ali Hossain</a> </p>
    </div>
